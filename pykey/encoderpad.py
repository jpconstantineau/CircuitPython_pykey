...
class EncoderPad(KB_Hardware):  # pylint: disable=too-few-public-methods
    ...
    def __init__(self, nkro: bool = False):
        ...
        # Below are Pro/Wireless EncoderPads
            ...
            self._leds = KB_LEDMatrix(
                (board.D1, board.D26, board.D20), (board.D6, board.D4, board.D8), True
            )
            ...
            self._leds = KB_LEDMatrix(
                (board.P0_08, board.P1_15, board.P1_11),
                (board.P1_00, board.P0_22, board.P1_04),
                True,
            )
            self._leds.reset_leds()
            ...
            self._leds = KB_LEDMatrix(
                (board.P0_08, board.P0_02, board.P0_03),
                (board.P0_24, board.P0_20, board.P0_10),
                True,
            )
            self._leds.reset_leds()
